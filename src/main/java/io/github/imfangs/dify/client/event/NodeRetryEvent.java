...
public class NodeRetryEvent extends BaseWorkflowEvent {

    /**
     * 详细内容
     */
    @JsonProperty("data")
    private NodeRetryData data;
    ...
    @Data
    @NoArgsConstructor
    public static class NodeRetryData {
        ...
        /**
         * 执行状态 running / succeeded / failed / stopped / retry
         */
        @JsonProperty("status")
